...
const PublicationsCard = ({ data }) => {
    ...
    return (
        <div className='PublicationsCard'>
            ...
            <p className='Note'>Kindly contact the author for access to full publication.</p>
            <LikeShareArea />
